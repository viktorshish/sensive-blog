...
def index(request):
    ...
    most_fresh_posts = fresh_posts.prefetch_related('author', 'tags')[:5][::-1]
...
def tag_filter(request, tag_title):
    ...
    related_posts = tag.posts.prefetch_related('author', 'tags').annotate(comments_count=Count('comments'))[:20]
